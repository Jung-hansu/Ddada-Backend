...
public enum PlayerErrorCode implements BaseErrorCode {
    ...
    INVALID_PASSWORD(BAD_REQUEST, "PLAYER_400_3", "비밀번호가 일치하지 않습니다."),
    INVALID_EMAIL(BAD_REQUEST, "PLAYER_400_4", "이메일 형식이 올바르지 않습니다."),
    INVALID_NICKNAME(BAD_REQUEST, "PLAYER_400_5", "닉네임 형식이 올바르지 않습니다."),
    INVALID_NAME(BAD_REQUEST, "PLAYER_400_6", "이름 형식이 올바르지 않습니다."),
    PLAYER_DUPLICATE(BAD_REQUEST, "PLAYER_400_7", "이미 존재하는 회원입니다."),
    MESSAGE_SENDING(BAD_REQUEST, "PLAYER_400_8", "메시지 전송에 실패하였습니다."),

    LOGIN_INFO_INVALID(UNAUTHORIZED, "PLAYER_401_1", "로그인 유저가 존재하지 않습니다."),
    ...
    PASSWORD_NOT_MATCH(NOT_FOUND, "PLAYER_404_6", "비밀번호가 일치하지 않습니다."),
    PHONE_NUMBER_NOT_FOUND(NOT_FOUND, "PLAYER_404_7", "존재하지 않는 전화번호입니다."),
    KAKAO_MAIL_PLAYER_NOT_FOUND(NOT_FOUND, "PLAYER_404_8", "카카오 메일에 해당하는 회원을 찾을 수 없습니다."),
