...
import static ssafy.ddada.api.StatusCode.BAD_REQUEST;
import static ssafy.ddada.api.StatusCode.NOT_FOUND;
...
public enum S3ErrorCode implements BaseErrorCode{
    ...
    IMAGE_UPLOAD_FAILED(BAD_REQUEST, "S3_400_3", "이미지 업로드에 실패하였습니다."),
